...
struct FloatOptional {
 ...
 public:
  ...
  constexpr bool isUndefined() const {
    return iris::ui::isUndefined(value_);
  }

  constexpr bool isDefined() const {
    return iris::ui::isDefined(value_);
  }
};
...
constexpr FloatOptional maxOrDefined(FloatOptional lhs, FloatOptional rhs) {
  return FloatOptional{iris::ui::maxOrDefined(lhs.unwrap(), rhs.unwrap())};
}

inline bool inexactEquals(FloatOptional lhs, FloatOptional rhs) {
  return iris::ui::inexactEquals(lhs.unwrap(), rhs.unwrap());
}
