...
class YG_EXPORT Style {
 public:
  ...
  Style::Length margin(Edge edge) const {
    return pool_.getLength(margin_[iris::ui::to_underlying(edge)]);
  }
  void setMargin(Edge edge, Style::Length value) {
    pool_.store(margin_[iris::ui::to_underlying(edge)], value);
  }

  Style::Length position(Edge edge) const {
    return pool_.getLength(position_[iris::ui::to_underlying(edge)]);
  }
  void setPosition(Edge edge, Style::Length value) {
    pool_.store(position_[iris::ui::to_underlying(edge)], value);
  }

  Style::Length padding(Edge edge) const {
    return pool_.getLength(padding_[iris::ui::to_underlying(edge)]);
  }
  void setPadding(Edge edge, Style::Length value) {
    pool_.store(padding_[iris::ui::to_underlying(edge)], value);
  }

  Style::Length border(Edge edge) const {
    return pool_.getLength(border_[iris::ui::to_underlying(edge)]);
  }
  void setBorder(Edge edge, Style::Length value) {
    pool_.store(border_[iris::ui::to_underlying(edge)], value);
  }

  Style::Length gap(Gutter gutter) const {
    return pool_.getLength(gap_[iris::ui::to_underlying(gutter)]);
  }
  void setGap(Gutter gutter, Style::Length value) {
    pool_.store(gap_[iris::ui::to_underlying(gutter)], value);
  }

  Style::SizeLength dimension(Dimension axis) const {
    return pool_.getSize(dimensions_[iris::ui::to_underlying(axis)]);
  }
  void setDimension(Dimension axis, Style::SizeLength value) {
    pool_.store(dimensions_[iris::ui::to_underlying(axis)], value);
  }

  Style::SizeLength minDimension(Dimension axis) const {
    return pool_.getSize(minDimensions_[iris::ui::to_underlying(axis)]);
  }
  void setMinDimension(Dimension axis, Style::SizeLength value) {
    pool_.store(minDimensions_[iris::ui::to_underlying(axis)], value);
  }
  ...
  Style::SizeLength maxDimension(Dimension axis) const {
    return pool_.getSize(maxDimensions_[iris::ui::to_underlying(axis)]);
  }
  void setMaxDimension(Dimension axis, Style::SizeLength value) {
    pool_.store(maxDimensions_[iris::ui::to_underlying(axis)], value);
  }
  ...
  bool horizontalInsetsDefined() const {
    return position_[iris::ui::to_underlying(Edge::Left)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::Right)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::All)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::Horizontal)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::Start)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::End)].isDefined();
  }

  bool verticalInsetsDefined() const {
    return position_[iris::ui::to_underlying(Edge::Top)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::Bottom)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::All)].isDefined() ||
        position_[iris::ui::to_underlying(Edge::Vertical)].isDefined();
  }
 ...
 private:
  ...
  Style::Length computeColumnGap() const {
    if (gap_[iris::ui::to_underlying(Gutter::Column)].isDefined()) {
      return pool_.getLength(gap_[iris::ui::to_underlying(Gutter::Column)]);
    } else {
      return pool_.getLength(gap_[iris::ui::to_underlying(Gutter::All)]);
    }
  }

  Style::Length computeRowGap() const {
    if (gap_[iris::ui::to_underlying(Gutter::Row)].isDefined()) {
      return pool_.getLength(gap_[iris::ui::to_underlying(Gutter::Row)]);
    } else {
      return pool_.getLength(gap_[iris::ui::to_underlying(Gutter::All)]);
    }
  }
  ...
  Style::Length computeLeftEdge(const Edges& edges, Direction layoutDirection)
    ...
    if (layoutDirection == Direction::LTR &&
        edges[iris::ui::to_underlying(Edge::Start)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Start)]);
    } else if (
        layoutDirection == Direction::RTL &&
        edges[iris::ui::to_underlying(Edge::End)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::End)]);
    } else if (edges[iris::ui::to_underlying(Edge::Left)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Left)]);
    } else if (edges[iris::ui::to_underlying(Edge::Horizontal)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Horizontal)]);
    } else {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::All)]);
    }
  }

  Style::Length computeTopEdge(const Edges& edges) const {
    if (edges[iris::ui::to_underlying(Edge::Top)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Top)]);
    } else if (edges[iris::ui::to_underlying(Edge::Vertical)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Vertical)]);
    } else {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::All)]);
    }
  }
  ...
  Style::Length computeRightEdge(const Edges& edges, Direction layoutDirection)
    ...
    if (layoutDirection == Direction::LTR &&
      ...
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::End)]);
        ...
        edges[iris::ui::to_underlying(Edge::Start)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Start)]);
    } else if (edges[iris::ui::to_underlying(Edge::Right)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Right)]);
    } else if (edges[iris::ui::to_underlying(Edge::Horizontal)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Horizontal)]);
    } else {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::All)]);
  ...
  Style::Length computeBottomEdge(const Edges& edges) const {
    if (edges[iris::ui::to_underlying(Edge::Bottom)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Bottom)]);
    } else if (edges[iris::ui::to_underlying(Edge::Vertical)].isDefined()) {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::Vertical)]);
    } else {
      return pool_.getLength(edges[iris::ui::to_underlying(Edge::All)]);
