...
public:
  ...
  uint32_t writeBinaryView_virt(const std::string_view& str) override { return protocol->writeBinaryView(str); }
  ...
  uint32_t readBinaryView_virt(std::string_view& str) override { return protocol->readBinaryView(str); }
