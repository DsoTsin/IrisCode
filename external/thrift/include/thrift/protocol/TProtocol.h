...
public:
  ...
  virtual uint32_t writeBinaryView_virt(const std::string_view& str) = 0;
  ...
  uint32_t writeBinaryView(const std::string_view& str) {
    T_VIRTUAL_CALL();
    return writeBinaryView_virt(str);
  }
  ...
  virtual uint32_t readBinaryView_virt(std::string_view& str) = 0;
  ...
  uint32_t readBinaryView(std::string_view& str) {
    T_VIRTUAL_CALL();
    return readBinaryView_virt(str);
  }
