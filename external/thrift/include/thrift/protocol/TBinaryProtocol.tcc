...
template <class Transport_, class ByteOrder_>
uint32_t TBinaryProtocolT<Transport_, ByteOrder_>::writeBinaryView(const std::string_view& str) {
  return TBinaryProtocolT<Transport_, ByteOrder_>::writeString(str);
}
...
template <class Transport_, class ByteOrder_>
uint32_t TBinaryProtocolT<Transport_, ByteOrder_>::readBinaryView(std::string_view& str) {
  return -1;
}
