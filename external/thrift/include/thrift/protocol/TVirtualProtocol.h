...
public:
  ...
  uint32_t readBinaryView(std::string_view& str) {
    (void)str;
    throw TProtocolException(TProtocolException::NOT_IMPLEMENTED,
                             "this protocol does not support reading (yet).");
  }
  ...
  uint32_t writeBinaryView(const std::string_view& str) {
    (void)str;
    throw TProtocolException(TProtocolException::NOT_IMPLEMENTED,
                             "this protocol does not support writing (yet).");
  }
...
public:
  ...
  uint32_t writeBinaryView_virt(const std::string_view& str) override {
    return static_cast<Protocol_*>(this)->writeBinaryView(str);
  }
  ...
  uint32_t readBinaryView_virt(std::string_view& str) override {
    return static_cast<Protocol_*>(this)->readBinaryView(str);
  }
